  ...
  return (
    ...
    >
      <div className="w-full flex items-center justify-between px-3 md:px-24 py-3">
        <div>
          <Link to="/">
            <h1 className="text-2xl text-violet-600 font-lobster">Anurag Khokhar</h1>
          </Link>
        </div>
        <div>
            ...
            {navLinks.map((navItem) => (
              <li className="mx-4" key={navItem.title}>
                <NavLink
                  to={navItem.link}
                  style={activeLink}
                  className="text-white hover:text-violet-600 duration-300"
                >
                  {navItem.title}
                </NavLink>
              </li>
            ...
            >
              ...
              <div className="text-center">
                <p className="text-neutral">
                  &copy; Copyright 2024, Anurag Khokhar. All Rights Reserved
                </p>
              </div>
            </Drawer>
          </div>
