      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
        ...
        >
          ...
          <div className="flex items-center my-6">
            ...
            <h3 className="font-medium text-primary">Anurag Khokhar</h3>
          </div>
          <div className="flex items-center my-6">
            <FaPhoneAlt className="text-2xl mr-8 hover:text-primary cursor-pointer duration-300"></FaPhoneAlt>
            <h3 className="font-medium text-primary">+91 981 8126 029</h3>
          </div>
          <div className="flex items-center my-6">
            <MdEmail className="text-3xl mr-8 hover:text-primary cursor-pointer duration-300"></MdEmail>
            <h3 className="font-medium text-primary">anuragkhokhar635@gmail.com</h3>
          </div>
          <div className="flex items-center my-6">
          ...
          <div className="mt-8 flex items-center">
            ...
            <a
              href="https://www.linkedin.com/in/anurag-khokhar-020818225/"
              target="blank"
            ...
            <a
              href="https://github.com/AnuragKhokhar"
              target="blank"
              className="text-3xl text-neutral hover:text-primary hover:-translate-y-1.5 shadow-lg mx-1 duration-300"
            >
